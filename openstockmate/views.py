...
from .models import Component, Category, Location, LocationType, Document, DocumentType, Manufacturer, Package, Purchase, PurchaseDetail, Package, Supplier, StockMovement
from .forms import ComponentForm, CategoryForm, LocationForm, LocationTypeForm, DocumentForm, DocumentTypeForm, ManufacturerForm, PackageForm, PurchaseForm, PurchaseDetailForm, PackageForm, SupplierForm
"""

...
from .models import ComponentDocumentLink, Component, Purchase, StockMovement, LocationType, Manufacturer, Location, LocationType, StockAlert, Category, Component, Document, DocumentType, PurchaseDetail, Package, StokPage, Supplier
from django import forms
...
##sorun var 
class StokPageForm(forms.ModelForm):
    class Meta:
        model = StokPage
        fields = ['name', 'description']
        widgets = {
        ...
        def __init__(self, *args, **kwargs):
            super(StokPageForm, self).__init__(*args, **kwargs)
            self.fields['name'].widget.attrs['placeholder'] = 'Stok Page Name'
            self.fields['description'].widget.attrs['placeholder'] = 'Stok Page Description'
            self.fields['name'].widget.attrs['class'] = 'form-control'
            self.fields['description'].widget.attrs['class'] = 'form-control'
            self.fields['name'].widget.attrs['required'] = True
            self.fields['description'].widget.attrs['required'] = True
...
class ComponentForm(forms.ModelForm):
    class Meta:
        model = Component
        fields = ['model', 'description', 'manufacturer', 'category', 'package', 'location', 'stock', 'created_at', 'updated_at']
        widgets = {
...
class LocationForm(forms.ModelForm):
    class Meta:
        model = Location
        fields = ['name', 'description', 'location_type', 'parent_id']
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control'}),
            'description': forms.Textarea(attrs={'class': 'form-control'}),
...
class StockMovement(forms.ModelForm):
    class Meta:
        model = StockMovement
        fields = ['component', 'quantity', 'source_location', 'destination_location', 'created_at', 'updated_at']
        widgets = {
...
class PurchaseDetailForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['purchase', 'component', 'quantity', 'price']
        widgets = {
